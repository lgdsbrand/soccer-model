        ...
        <tbody>
          {standings.map((s, i) => (
            <tr key={s.team_id} style={{
              ...
              <td style={{ padding: "10px", textAlign: "center", fontSize: "12px", color: "var(--text-muted)", fontWeight: 700 }}>
                {s.rank}
              </td>
              ...
              <td style={{ padding: "10px", textAlign: "center", fontSize: "14px", fontWeight: 800, color: "var(--text-secondary)" }}>
                {s.points}
              </td>
            </tr>
          ))}
